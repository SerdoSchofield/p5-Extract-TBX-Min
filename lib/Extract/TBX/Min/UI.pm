#!/usr/bin/perl -w -- 
#
# generated by wxGlade 0.7.2 on Thu Nov 10 16:37:23 2016
#
...
sub new {
    ...
    $self->{label_2} = Wx::StaticText->new($self, wxID_ANY, "Default TBX-Min Data Categories", wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER);
    $self->{cb_subjectField} = Wx::CheckBox->new($self, wxID_ANY, "subjectField");
    $self->{cb_termStatus} = Wx::CheckBox->new($self, wxID_ANY, "termStatus");
    $self->{cb_customer} = Wx::CheckBox->new($self, wxID_ANY, "customer");
    $self->{cb_pos} = Wx::CheckBox->new($self, wxID_ANY, "partOfSpeech");
    $self->{label_1} = Wx::StaticText->new($self, wxID_ANY, "Other Data Categories", wxDefaultPosition, wxDefaultSize, wxALIGN_CENTER);
    $self->{check_list_box_2} = Wx::CheckListBox->new($self, wxID_ANY, wxDefaultPosition, wxDefaultSize, [], );
    $self->{label_3} = Wx::StaticText->new($self, wxID_ANY, "Creator:");
    $self->{text_ctrl_1} = Wx::TextCtrl->new($self, wxID_ANY, "");
    $self->{label_4} = Wx::StaticText->new($self, wxID_ANY, "License");
    $self->{text_ctrl_2} = Wx::TextCtrl->new($self, wxID_ANY, "");
    $self->{label_5} = Wx::StaticText->new($self, wxID_ANY, "*Directionality:");
    $self->{combo_box_1} = Wx::ComboBox->new($self, wxID_ANY, "", wxDefaultPosition, wxDefaultSize, ["monodirectional", "bidirectional"], wxCB_DROPDOWN);
    $self->{label_6} = Wx::StaticText->new($self, wxID_ANY, "Description:");
    $self->{text_ctrl_3} = Wx::TextCtrl->new($self, wxID_ANY, "");
    $self->{label_7} = Wx::StaticText->new($self, wxID_ANY, "* indicates required");
    $self->{button_extract} = Wx::Button->new($self, wxID_ANY, "Extract");
...
sub __set_properties {
    ...
    $self->SetTitle("TBX-Basic to TBX-Min Extractor");
...
sub __do_layout {
    ...
    $self->{sizer_9} = Wx::StaticBoxSizer->new(Wx::StaticBox->new($self, wxID_ANY, "Define Header Variables:"), wxVERTICAL);
    ...
    $self->{sizer_3} = Wx::StaticBoxSizer->new(Wx::StaticBox->new($self, wxID_ANY, "Select Languages and Data Categories to Export"), wxVERTICAL);
